...
export const theme = createTheme({
  ...
  textVariants: {
    // Obrigatório para usar o createText
    defaults: {},
  },
});
...
export type ThemeColors = keyof Theme['colors']; // 'primary' | 'primaryContrast' | 'background' | 'backgroundContrast' | 'error' | 'errorLight' | 'success' | 'successLight'
